...
<tags:master pageTitle="Order">
    ...
    <div class="container mt-4">
        <p class="font-weight-normal">Order number: ${order.id}</p>
        <p class="font-weight-normal">Order status: ${order.status}</p>
        ...
        <form>
            <p>
                <button class="btn btn-outline-primary" formaction="${pageContext.servletContext.contextPath}/admin/orders">
                    Back
                </button>
                <button class="btn btn-success" formmethod="post" formaction="${pageContext.servletContext.contextPath}/admin/orders/${order.id}?status=DELIVERED">
                    Delivered
                </button>
                <button class="btn btn-danger" formmethod="post" formaction="${pageContext.servletContext.contextPath}/admin/orders/${order.id}?status=REJECTED">
                    Rejected
                </button>
            </p>
        </form>
